...
//         */
//        private assign10.TimerTemplate.Result timeIt(int n){
//
...
//            return new assign10.TimerTemplate.Result(n, averageTime);
//        }
//
//        /**
...
//         */
//        TimerTemplate.Result[] run(){
//            var ret = new assign10.TimerTemplate.Result[problemSizes.length];
//            for(int i = 0; i < problemSizes.length; i++){
//                ret[i] = timeIt(problemSizes[i]);
//                System.out.println(ret[i].n() + " - " + ret[i].avgNanoSecs());
//            }
//            return ret;
//        }
//
